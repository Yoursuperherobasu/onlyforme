...
from agentcore.logging.logger import InterceptHandler


class AgentcoreUvicornWorker(UvicornWorker):
...
class AgentcoreApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "agentcore.server.AgentcoreUvicornWorker"
