...
PERMISSIONS = [
    ...
    ("view_prod", "Agent Control Panel"),
    ("prod_share_agent", "Agent Control Panel"),
    ("prod_start_stop_agent", "Agent Control Panel"),
    ("prod_enable_disable_agent", "Agent Control Panel"),
    ("view_uat", "Agent Control Panel"),
    ("uat_share_agent", "Agent Control Panel"),
    ("uat_start_stop_agent", "Agent Control Panel"),
    ("uat_enable_disable_agent", "Agent Control Panel"),
    ...
    ("view_knowledge_base", "Knowledge Base Management"),
    ("add_new_knowledge", "Knowledge Base Management"),
