...
def create_agentcore_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Agentcore initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Agentcore", "Setting up basic configuration"),
        ...
        ("Launching Agentcore", "Starting server and final setup"),
    ]
...
def create_agentcore_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Agentcore shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
