...
class MessageStoreNode(Node):
    ...
    description = "Stores a chat message or text into Agentcore tables or an external memory."
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="The external memory to store the message. If empty, it will use the Agentcore tables.",
        ),
        MessageTextInput(
            name="sender",
            display_name="Sender",
