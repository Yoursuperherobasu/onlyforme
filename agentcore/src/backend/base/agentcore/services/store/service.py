...
from agentcore.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from agentcore.services.store.schema import (
...
from agentcore.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.agentcore.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates agentcore with the store which is a Directus instance.
