...
# Log file paths - dynamically resolve agentcore root from this file's location
# Navigate up from utils/ to agentcore root: utils -> agentcore -> base -> backend -> src -> agentcore
