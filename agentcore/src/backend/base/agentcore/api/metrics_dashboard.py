...
KPI_PRESETS = [
    ...
    },
    {
        ...
        "section": "Platform Health",
        "query": "histogram_quantile(0.95, sum(rate(http_server_request_duration_ms_bucket[5m])) by (le))",
        "unit": "ms",
    ...
    },
    {
        ...
        "section": "Platform Health",
        "query": "histogram_quantile(0.99, sum(rate(http_server_request_duration_ms_bucket[5m])) by (le))",
        "unit": "ms",
    ...
    },
    {
        ...
        "section": "Experience",
        "query": "avg(rate(http_server_request_duration_ms_sum[5m]) / clamp_min(rate(http_server_request_duration_ms_count[5m]), 0.001))",
        "unit": "ms",
    ...
    },
    {
        ...
        "query": "avg(rate(agentcore_agent_run_duration_ms_sum[5m]) / clamp_min(rate(agentcore_agent_run_duration_ms_count[5m]), 0.001))",
        "unit": "ms",
    ...
    },
    {
        ...
        "section": "Developer Performance",
        "query": "histogram_quantile(0.95, sum(rate(agentcore_agent_run_duration_ms_bucket[5m])) by (le))",
        "unit": "ms",
    ...
    },
    {
        ...
        "section": "Developer Performance",
        "query": "histogram_quantile(0.99, sum(rate(agentcore_agent_run_duration_ms_bucket[5m])) by (le))",
        "unit": "ms",
...
CHART_PRESETS = [
    {
        ...
        "type": "line",
        "queries": [
            {"label": "P95", "query": "histogram_quantile(0.95, sum(rate(http_server_request_duration_ms_bucket[5m])) by (le))"},
            {"label": "P99", "query": "histogram_quantile(0.99, sum(rate(http_server_request_duration_ms_bucket[5m])) by (le))"},
        ],
        "unit": "ms",
    },
    {
    ...
    },
    {
        ...
        "type": "line",
        "queries": [
            {"label": "Avg Response Time", "query": "avg(rate(http_server_request_duration_ms_sum[5m]) / clamp_min(rate(http_server_request_duration_ms_count[5m]), 0.001))"},
        ],
        "unit": "ms",
    },
    {
        ...
        "type": "line",
        "queries": [
            {"label": "P95", "query": "histogram_quantile(0.95, sum(rate(agentcore_agent_run_duration_ms_bucket[5m])) by (le))"},
            {"label": "P99", "query": "histogram_quantile(0.99, sum(rate(agentcore_agent_run_duration_ms_bucket[5m])) by (le))"},
        ],
        "unit": "ms",
    },
    {
