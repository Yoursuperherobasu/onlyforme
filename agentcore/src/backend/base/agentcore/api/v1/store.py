...
from agentcore.api.utils import CurrentActiveUser, check_agentcore_version
from agentcore.services.auth import utils as auth_utils
from agentcore.services.deps import get_settings_service, get_store_service
from agentcore.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_agentcore_version(component)
