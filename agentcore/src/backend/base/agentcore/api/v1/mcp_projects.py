...
from agentcore.api.utils import CurrentActiveMCPUser
from agentcore.api.v1.mcp_utils import (
    current_user_ctx,
    handle_call_tool,
    ...
    try:
        async with session_scope() as session:
            ...
            if project.auth_settings:
                from agentcore.api.v1.schemas import AuthSettings
...
class ProjectMCPServer:
    def __init__(self, project_id: UUID):
        ...
        self.server = Server(f"agentcore-mcp-project-{project_id}")
