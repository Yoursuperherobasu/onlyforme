...
from agentcore.services.database.models.variable.model import VariableCreate, VariableRead, VariableUpdate
from agentcore.services.deps import get_variable_service
