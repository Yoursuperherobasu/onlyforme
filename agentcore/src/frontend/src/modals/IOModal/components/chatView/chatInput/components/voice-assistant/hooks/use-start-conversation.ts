...
export const useStartConversation = (
  ...
  const url = `${protocol}//${currentHost}:${currentPort}/api/voice/ws/flow_tts/${flowId}/${currentSessionId?.toString()}`;
  //const url = `${protocol}//${currentHost}:${currentPort}/api/voice/ws/flow_as_tool/${flowId}/${currentSessionId?.toString()}`;
