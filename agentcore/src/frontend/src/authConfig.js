import { LogLevel } from '@azure/msal-browser';
 ...
 export const msalConfig = {
     auth: {
         ...
         redirectUri: 'http://localhost:3000/agents', // Must EXACTLY match Azure Portal redirect URI
        // If Azure Portal has http://127.0.0.1:3000/agents instead, change above to match
