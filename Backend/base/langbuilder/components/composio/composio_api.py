...
# from composio import Action  # Action is not available in current composio version
# from composio import App  # App is not available in composio 0.8.5
...
class ComposioAPIComponent(LCToolComponent):
    ...
    def validate_tool(self, build_config: dict, field_value: Any, connected_app_names: list) -> dict:
        ...
        # NOTE: Action.all() is not available in current composio version
        # Commenting out until composio version is updated
    ...
    def update_build_config(self, build_config: dict, field_value: Any, field_name: str | None = None) -> dict:
        ...
        if field_name == "tool_name" and field_value:
            ...
            toolset = LangchainProvider(api_key=self.api_key)
    ...
    def _build_wrapper(self) -> LangchainProvider:
        """Build the Composio toolset wrapper.

        Returns:
            LangchainProvider: The initialized toolset.
        ...
        try:
            ...
            return LangchainProvider(api_key=self.api_key, entity_id=self.entity_id)
