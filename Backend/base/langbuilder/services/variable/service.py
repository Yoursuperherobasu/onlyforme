...
from langbuilder.services.auth import utils as auth_utils
from langbuilder.services.base import Service
from langbuilder.services.database.models.variable.model import Variable, VariableCreate, VariableRead, VariableUpdate
from langbuilder.services.variable.base import VariableService
from langbuilder.services.variable.constants import CREDENTIAL_TYPE, GENERIC_TYPE
...
class DatabaseVariableService(VariableService, Service):
    ...
    async def update_variable_fields(
        ...
        db_variable.updated_at = datetime.now(timezone.utc).replace(tzinfo=None)
