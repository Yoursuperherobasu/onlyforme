...
from langbuilder.base.prompts.utils import dict_values_to_string
from langbuilder.schema.content_block import ContentBlock
from langbuilder.schema.content_types import ErrorContent
from langbuilder.schema.data import Data
from langbuilder.schema.image import Image, get_file_paths, is_image_file
from langbuilder.schema.properties import Properties, Source
from langbuilder.schema.validators import timestamp_to_str, timestamp_to_str_validator
from langbuilder.utils.constants import (
    MESSAGE_SENDER_AI,
    MESSAGE_SENDER_NAME_AI,
    MESSAGE_SENDER_NAME_USER,
    MESSAGE_SENDER_USER,
)
from langbuilder.utils.image import create_image_content_dict
...
class Message(Data):
    ...
    def serialize_timestamp(self, value):
        ...
        formats = [
            "%Y-%m-%d %H:%M:%S.%f %Z",  # With microseconds and timezone (e.g., "2026-01-06 09:12:14.532252 UTC")
    ...
    def to_dataframe(self) -> DataFrame:
        from langbuilder.schema.dataframe import DataFrame  # Local import to avoid circular import
