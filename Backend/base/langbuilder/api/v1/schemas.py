...
from langbuilder.schema.schema import InputType, OutputType, OutputValue
...
class VertexBuildResponse(BaseModel):
    ...
    timestamp: datetime | None = Field(default_factory=lambda: datetime.now(timezone.utc).replace(tzinfo=None))
