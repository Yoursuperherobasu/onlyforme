...
# Composio 0.8.5 compatibility - these modules don't exist in this version
try:
...
class NoItemsFound(Exception):
    """Stub for missing composio.client.exceptions.NoItemsFound"""
    pass

class AppAuthScheme:
    """Stub for missing composio.client.collections.AppAuthScheme"""
    def __init__(self):
        self.auth_mode = None
...
class ComposioBaseComponent(Component):
    ...
    def _build_wrapper(self) -> LangchainProvider:
        ...
        try:
            ...
            return LangchainProvider(api_key=self.api_key)
