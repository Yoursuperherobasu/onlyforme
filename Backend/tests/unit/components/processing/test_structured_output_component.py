...
class TestStructuredOutputComponent(ComponentTestBaseWithoutClient):
    ...
    def test_successful_structured_output_generation_with_patch_with_config(self):
        ...
        with patch("langbuilder.components.processing.structured_output.get_chat_result", mock_get_chat_result):
    ...
    @patch("langbuilder.components.processing.structured_output.get_chat_result")
    ...
    def test_build_structured_output_fails_when_base_returns_non_list(self):
        ...
        with (
            patch("langbuilder.components.processing.structured_output.get_chat_result", mock_get_chat_result),
