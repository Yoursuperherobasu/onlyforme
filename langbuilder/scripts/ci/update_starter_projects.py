...
import langbuilder.main  # noqa: F401
...
async def main():
    ...
    Copies the code from langbuilder/initial_setup/setup.py. Doesn't use the
    ...
    for project_path, project in starter_projects:
        ...
        do_update_starter_projects = os.environ.get("LANGBUILDER_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
