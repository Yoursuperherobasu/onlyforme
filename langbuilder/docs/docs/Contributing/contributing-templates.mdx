...
Follow these best practices when submitting a template to LangBuilder.

For template formatting examples, see [`/starter_projects`](https://github.com/CloudGeometry/langbuilder/tree/main/src/backend/base/langbuilder/initial_setup/starter_projects) in the LangBuilder repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [LangBuilder repository](https://github.com/CloudGeometry/langbuilder) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main LangBuilder repository.
5. Include a screenshot of your template in the PR.

The LangBuilder team will review your PR, offer feedback, and, if approved, merge the template.
...
For more information, see the LangBuilder repository's [template categories](https://github.com/CloudGeometry/langbuilder/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).