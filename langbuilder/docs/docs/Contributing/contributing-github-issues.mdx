...
The LangBuilder GitHub repository is an integral part of the [LangBuilder community](/contributing-community).

In addition to general assistance with LangBuilder, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by LangBuilder maintainers.
...
Because the Issues and Discussion pages are public, the LangBuilder team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The LangBuilder team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading LangBuilder or a dependency.
* **Describe your environment**: Include your operating system, LangBuilder version, Python version, and any other environment-related details that could have contributed to the issue.
