---
title: Integrate NVIDIA G-Assist with LangBuilder
slug: /integrations-nvidia-g-assist
---

:::important
The **NVIDIA G-Assist** component is available only for LangBuilder users with NVIDIA GPUs on Windows systems.
:::
...
* NVIDIA GPU
* `gassist.rise` package installed. This package is included in your [LangBuilder installation](/get-started-installation).
