...
**Language Model** components in LangBuilder generate text using a specified Large Language Model (LLM).

LangBuilder includes a **Language Model** core component that has built-in support for many LLMs.
