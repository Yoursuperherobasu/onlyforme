...
from langbuilder.graph.schema import CHAT_COMPONENTS
from langbuilder.utils.lazy_load import LazyLoadDictBase

if TYPE_CHECKING:
    from langbuilder.graph.vertex.base import Vertex
    from langbuilder.graph.vertex.vertex_types import CustomComponentVertex
...
def _import_vertex_types():
    from langbuilder.graph.vertex import vertex_types
