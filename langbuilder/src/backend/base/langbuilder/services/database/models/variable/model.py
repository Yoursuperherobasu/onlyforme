...
from langbuilder.services.variable.constants import CREDENTIAL_TYPE
...
class VariableCreate(VariableBase):
    created_at: datetime | None = Field(default_factory=lambda: datetime.now(timezone.utc), description="Creation time of the variable")

    updated_at: datetime | None = Field(default_factory=lambda: datetime.now(timezone.utc), description="Last update time of the variable")
