...
from langbuilder.inputs.validators import CoalesceBool
from langbuilder.schema.data import Data
from langbuilder.schema.message import Message
from langbuilder.services.database.models.message.model import MessageBase
    ...
    def validate_value(cls, v: Any, _info):
        ...
        if not isinstance(v, list):
            msg = (
                ...
                "- A Data object (Langbuilder's internal data structure)\n"
            )
        ...
        for i, item in enumerate(v):
            if not isinstance(item, dict | Data):
                msg = (
                    ...
                    "- A Data object (Langbuilder's internal data structure for passing data between components)\n"
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Langbuilder system.

    This component is used to handle text inputs in the Langbuilder system.
