...
from langbuilder.api.v2.mcp import get_server
from langbuilder.base.agents.utils import maybe_unflatten_dict, safe_cache_get, safe_cache_set
...
class MCPToolsNode(NodeWithCache):
    ...
    async def _validate_schema_inputs(self, tool_obj) -> list[InputTypes]:
        ...
        try:
            ...
            schema_inputs = schema_to_langbuilder_inputs(input_schema)
    ...
    def get_inputs_for_all_tools(self, tools: list) -> dict:
        ...
        for tool in tools:
            ...
            try:
                ...
                input_schema = create_input_schema_from_json_schema(flat_schema)
                langbuilder_inputs = schema_to_langbuilder_inputs(input_schema)
                inputs[tool.name] = langbuilder_inputs
    ...
    async def build_output(self) -> DataFrame:
        ...
        try:
            ...
            if self.tool != "":
                # Set session context for persistent MCP sessions using Langbuilder session ID
    ...
    def _get_session_context(self) -> str | None:
        """Get the Langbuilder session ID for MCP session caching."""
