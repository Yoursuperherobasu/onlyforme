...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the LangBuilder run endpoint.
    ...
    Environment Variables:
      - LANGBUILDER_HOST: Base URL for the LangBuilder server (default: http://localhost:7860)
    ...
    host = os.getenv("LANGBUILDER_HOST", "http://localhost:7860")
    ...
    def run_flow_endpoint(self):
        ...
        payload = {
            "input_value": (
                "Hey, Could you check https://docs.langbuilder.org for me? Later, could you calculate 1390 / 192 ?"
            ),
            "output_type": "chat",
            "input_type": "chat",
            "tweaks": {},
