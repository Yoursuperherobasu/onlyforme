...
import pytest
from langbuilder.components.xai.xai import XAIModelComponent
...
class TestXAIComponent(ComponentTestBaseWithoutClient):
    ...
    def test_build_model(self, component_class, default_kwargs, mocker):
        ...
        mock_chat_openai = mocker.patch("langbuilder.components.xai.xai.ChatOpenAI", return_value=MagicMock())
    ...
    def test_build_model_error(self, component_class, mocker):
        ...
        mocker.patch(
            "langbuilder.components.xai.xai.ChatOpenAI",
    ...
    def test_json_mode(self, component_class, mocker):
        ...
        mocker.patch("langbuilder.components.xai.xai.ChatOpenAI", return_value=mock_instance)
