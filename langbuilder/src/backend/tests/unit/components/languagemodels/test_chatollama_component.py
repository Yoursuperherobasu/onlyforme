...
from langbuilder.components.ollama.ollama import ChatOllamaComponent
...
class TestChatOllamaComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langbuilder.components.ollama.ollama.ChatOllama")
    ...
    @pytest.mark.asyncio
    @patch("langbuilder.components.ollama.ollama.httpx.AsyncClient.post")
    @patch("langbuilder.components.ollama.ollama.httpx.AsyncClient.get")
