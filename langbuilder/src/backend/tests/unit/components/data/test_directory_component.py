...
import pytest
from langbuilder.components.data import DirectoryComponent
...
class TestDirectoryComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langbuilder.components.data.directory.parallel_load_data")
    @patch("langbuilder.components.data.directory.retrieve_file_paths")
    @patch("langbuilder.components.data.DirectoryComponent.resolve_path")
