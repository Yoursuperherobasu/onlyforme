...
from langbuilder.services.database.models.flow import FlowUpdate
...
async def test_cancel_build_unexpected_error(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    import langbuilder.api.v1.chat

    original_cancel_flow_build = langbuilder.api.v1.chat.cancel_flow_build

    async def mock_cancel_flow_build_with_error(*_args, **_kwargs):
        msg = "Unexpected error during cancellation"
        raise RuntimeError(msg)

    monkeypatch.setattr(langbuilder.api.v1.chat, "cancel_flow_build", mock_cancel_flow_build_with_error)
    ...
    try:
        ...
        monkeypatch.setattr(langbuilder.api.v1.chat, "cancel_flow_build", original_cancel_flow_build)
...
async def test_cancel_build_success(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    monkeypatch.setattr(langbuilder.api.v1.chat, "cancel_flow_build", mock_successful_cancel_flow_build)
...
async def test_cancel_build_failure(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    monkeypatch.setattr(langbuilder.api.v1.chat, "cancel_flow_build", mock_cancel_flow_build)
...
async def test_cancel_build_with_cancelled_error(client, json_memory_chatbot_no_llm, logged_in_headers, monkeypatch):
    ...
    monkeypatch.setattr(langbuilder.api.v1.chat, "cancel_flow_build", mock_cancel_flow_build_with_cancelled_error)
