...
import pytest
from langbuilder.services.database.models.flow import Flow as FlowTable
from langbuilder.services.database.models.message.model import MessageTable
from langbuilder.services.deps import get_settings_service, get_storage_service, session_scope
from langbuilder.services.task.temp_flow_cleanup import (
    CleanupWorker,
...
async def test_cleanup_worker_run_with_exception(mocker):
    ...
    mock_logger = mocker.patch("langbuilder.services.task.temp_flow_cleanup.logger")
