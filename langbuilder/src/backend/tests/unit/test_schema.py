...
import pytest
from langbuilder.inputs.inputs import BoolInput, DictInput, FloatInput, InputTypes, IntInput, MessageTextInput
from langbuilder.io.schema import schema_to_langbuilder_inputs
from langbuilder.schema.data import Data
from langbuilder.template import Input, Output
from langbuilder.template.field.base import UNDEFINED
from langbuilder.type_extraction.type_extraction import post_process_type
...
def test_schema_to_langbuilder_inputs():
...
def test_schema_to_langbuilder_inputs_invalid_type():
    ...
    with pytest.raises(TypeError, match="Unsupported field type:"):
        schema_to_langbuilder_inputs(InvalidSchema)
