...
"""
    ...
    pass  # Skip banner on Windows with encoding issues
...
try:
    ...
    # Handle Windows DLL errors (e.g., WinError 1114 with PyTorch)
    if "DLL" in str(e) or "1114" in str(e):
        log.warning(f"Skipping model initialization due to DLL issue (Windows): {e}")
        app.state.ef = None
        app.state.rf = None
    else:
